...
// decomposition was removing xml comments see https://github.com/forcedotcom/cli/issues/2830

describe('converting mdapi => source preserves xml comments', () => {
  const testDir = path.join('test', 'snapshot', 'sampleProjects', 'xmlComments');
