...
const testData = {
  ...
  bundleWebApplications: {
    ...
    expectedFilePaths: [getFilePath('uiBundles/MyWebApp/MyWebApp.webapplication-meta.xml')],
    // Content files are needed for the resolver to recognize the bundle but aren't generated by filePathGenerator.
    extraResolutionFilePaths: [getFilePath('uiBundles/MyWebApp/src/index.html')],
    expectedComponents: [
      {
        content: getFilePath('uiBundles/MyWebApp'),
        xml: getFilePath('uiBundles/MyWebApp/MyWebApp.webapplication-meta.xml'),
      },
    ],
  },
  bundleAppTemplates: {
