...
const PARENT_COMPONENT_NAME = 'parentName';
...
const CHILD_COMPONENT_NAME = 'childName';
...
export const NESTED_PARENT_COMPONENT = new SourceComponent({
...
export const NESTED_CHILD_COMPONENT = new SourceComponent({
